...
@Slf4j
@Component
public class NewportStrategy extends AbstractWebScraperStrategy {

    public NewportStrategy(
            @Value("${venue-name.newport}") String sourceName,
            @Value("${url.newport}") String locationUrl) {
